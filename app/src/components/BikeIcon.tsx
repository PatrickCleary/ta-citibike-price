// fa-bicycle, Font Awesome Free 6.7.2 (CC BY 4.0 — https://fontawesome.com/license/free)
// Inlined rather than pulled from @fortawesome/react-fontawesome: it's a single
// path, and the packages would be three dependencies to draw it.
